...
val grantTypeAuthorization: String = oauthKeys.getProperty("GRANT_TYPE_AUTHORIZATION", "")
val grantTypeRefreshToken: String = oauthKeys.getProperty("GRANT_TYPE_REFRESH_TOKEN", "")
...
val refreshToken: String = oauthKeys.getProperty("REFRESH_TOKEN", "")
...
android {
    ...
    buildTypes {
        getByName("debug") {
            ...
            buildConfigField("String","GRANT_TYPE_AUTHORIZATION", grantTypeAuthorization)
            buildConfigField("String","GRANT_TYPE_REFRESH_TOKEN", grantTypeRefreshToken)
            ...
            buildConfigField("String","REFRESH_TOKEN", refreshToken)
