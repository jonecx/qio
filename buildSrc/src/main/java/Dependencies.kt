object Dependencies {
    ...
    const val coreNavigation = "androidx.navigation:navigation-compose:${Versions.coreNavigationVersion}"
    ...
    const val lifecycleRuntimeCompose = "androidx.lifecycle:lifecycle-runtime-compose:${Versions.lifecycleRuntimeComposeVersion}"
